        ...
        <div class="ticket-booking-form">
            ...
            <form action="/addticket" method="POST" enctype="multipart/form-data">
                <div class="input-group-booking">
                    ...
                    <input class="input-field" type="text" id="ticket-type" name="type" required>
                </div>
                ...
                <div class="form-group-booking">
                    ...
                    <input type="number" class="input-field" id="ticket-price" name="price" required>
                </div>
                ...
                <div class="form-group-booking">
                    ...
                    <input type="file" class="input-field" id="ticket-attachment" name="picture" accept="image/*,application/pdf" onchange="previewImage(event)" />
                </div>

               
                <div class="form-group-booking des-textarea">
                    <label for="ticket-price">Description:</label>
                    <textarea type="text" class="input-field" id="ticket-price" name="description" required> </textarea>
                </div>
